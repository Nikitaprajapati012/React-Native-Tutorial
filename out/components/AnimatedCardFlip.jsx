...
const AnimatedCardFlip = () => {
    ...
    const frontImage = require('../images/image.jpeg')
    const backImage = require('../images/react.png')
...
<Text className='text-sm text-gray-600 mt-1'>This is back side</Text>
      ...
      <TouchableOpacity className='mt-8 px-8 py-3 bg-[#4a90e2] rounded-lg shadow-md'
      onPress={handleFlip}>
